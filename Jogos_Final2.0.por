programa {
  funcao inicio() {
    ...
    inteiro cor_roupa, pontos = 100, bolsa, acessorios, loop = 2

    //Repetição (quando acabar a partida, o jogo recomeça)
    enquanto (loop > 1) {
      //Título
      escreva("\n-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.")
      escreva("\n __  __           _                    __  __             _       ")
      ...
      escolha (modelo) {
        caso 'A' :
        {
          ...
          para (inteiro i = 1; i <= 3; i++) {  //Esse "para" serve para repetir as perguntas
      ...
      escreva("\n* Deseja continuar jogando: 1 -Nao, encerrar o jogo  ou 2 - Sim, jogar novamente --> ")
      leia(loop)
    }
  }
}